...
export default function PositionTabs({ activePosition, onPositionChange }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 bg-slate-100 rounded-2xl p-1 gap-1">
      {positions.map((position) => {
        ...
        return (
          <button
            ...
            className="text-slate-900 px-3 py-2 text-xs font-medium rounded-xl relative flex items-center justify-center transition-colors duration-200 hover:text-slate-700 text-center">
